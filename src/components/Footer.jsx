            ...
            <div className={styles.mainFootH}>
                <div className={styles.sDivs1}>
                    ...
                    <div className={styles.labelF1}>
                        <img className={styles.msg} src="https://d36g7qg6pk2cm7.cloudfront.net/assets/icons/white-mail-f7a800f328eab451231c558115ad0067bdd6c5ba04b7acd19f22ae4036e702d1.png" alt="da"></img>
                        <p>support@royalbrothers.com</p>
                        <img className={styles.call} src="https://d36g7qg6pk2cm7.cloudfront.net/assets/icons/white-phone-d7daea12563d63fb4bd1cbb2fa0a824d19501def56934aff125e23343912895e.png" alt=""></img>
