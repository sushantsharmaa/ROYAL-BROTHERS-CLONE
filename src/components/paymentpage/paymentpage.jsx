        ...
        <div className="main">
            <div className="card main-card">
                    <div className=" child-card">
                            ...
                            <hr className="hr"/>
                            <img onClick={() => setShow("zesto")} style={{ width: "30%", margin: "auto" }} src="https://d36g7qg6pk2cm7.cloudfront.net/assets/zest-ba7b00f2280b8dccaf218f9583ac1fce72183ccf866769d548bfe887bdb877ae.png" alt="test" />
                            <hr className="hr"/>
                            <img onClick={() => setShow("paytm")} style={{ width: "30%", margin: "auto" }} src="https://d36g7qg6pk2cm7.cloudfront.net/assets/paytm_logo-fa816f9adc5494b20bd1d42dde2a740ecf907e3514f3a3ffab3f680fe0e80256.png" alt="test" />
                    </div>              
